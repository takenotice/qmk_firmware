 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------+------+------+------|
 * | Shft |Z/Ctrl|   X  |   C  |   V  |   B  |Super |      | Meh  |   N  |   M  |   ,  |   .  |//Ctrl| Shft |
 * |------+------+------+------+------+------+------+------+------+------+------+------+------+------+------|
 * |`/SYMB| Esc  | MDIA | Alt  |Sp/MDA| Tab  | Tab  |      |Space |Space | Left | Down | Up   | Right|~SYMB |
 * `--------------------------------------------------------------------------------------------------------'
 */
[QRTY] = LAYOUT(
  ...
  KC_BSPC, _MD_A,   KC_S,    KC_D,    KC_F,    KC_G,    KC_NO,   KC_NO,   KC_NO,   KC_H,    KC_J,    KC_K,    KC_L,    _MD_SCN, _WN_QOT,
  KC_LSFT, _CTL_Z,  KC_X,    KC_C,    KC_V,    KC_B,    _META,   KC_NO,   _MEH,    KC_N,    KC_M,    KC_COMM, KC_DOT,  _CTL_SL, _RSH_EN,
  _SY_GRV, KC_ESC,  _MD_MO,  KC_LALT, _MD_SPC, KC_TAB,  KC_TAB,  KC_NO,   KC_SPC,  KC_SPC,  KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, _TAP_SY
),
 ...
 *
 * ,--------------------------------------------------------------------------------------------------------.
 * | Esc  |  F1  |  F2  |  F3  |  F4  |  F5  |  F21 |  F22 |  F23 |  F6  |  F7  |  F8  |  F9  |  F10 |  F11 |
 * |------+------+------+------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |   !  |   @  |   {  |   }  |   |  |      |  F24 |      |      |   7  |   8  |   9  |   *  |  F12 |
 * |------+------+------+------+------+------+------+------+------+------+------+------+------+------+------|
 * | CAPS |   #  |   $  |   (  |   )  |   `  |      |      |      |      |   4  |   5  |   6  |   +  |   -  |
 ...
 */
[SYMB] = LAYOUT(
  KC_ESC,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F21,  KC_F23,  KC_F14,  KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,
  KC_TRNS, KC_EXLM, KC_AT,   KC_LCBR, KC_RCBR, KC_PIPE, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_7,    KC_8,    KC_9,    KC_ASTR, KC_F12,
  KC_CAPS, KC_HASH, KC_DLR,  KC_LPRN, KC_RPRN, KC_GRV,  KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_4,    KC_5,    KC_6,    KC_PLUS, KC_MINS,
 ...
 *
 * ,--------------------------------------------------------------------------------------------------------.
 * |  Esc | F11  | F12  | F13  | F14  | F15  |QWERTY|      |COLMAK| F16  | F17  | F18  | F19  | F20  |      |
 * |------+------+------+------+------+------+------+------+------+------+------+------+------+------+------|
 ...
 */
[MDIA] = LAYOUT(
  KC_ESC,  KC_F11,  KC_F12,  KC_F13,  KC_F14,  KC_F15,  _D_QRTY, KC_TRNS, _D_COMK, KC_F16,  KC_F17,  KC_F18,  KC_F19,   KC_F20,  KC_TRNS,
  KC_TRNS, KC_WH_L, KC_WH_U, KC_MS_U, KC_WH_D, KC_WH_R, KC_TRNS, KC_TRNS, KC_TRNS, KC_PGUP, KC_HOME, KC_TRNS, KC_END,   KC_PSCR, KC_TRNS,
  KC_TRNS, KC_TRNS, KC_MS_L, KC_MS_D, KC_MS_R, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_LEFT, KC_DOWN, KC_UP,   KC_RIGHT, KC_TRNS, KC_MPLY,

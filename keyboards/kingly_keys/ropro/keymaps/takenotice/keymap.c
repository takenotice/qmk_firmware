...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   *        | + =  |   1  |   2  |   3  |   4  |   5  |   6  |   7  |   8  |   9  |   0  |   -  |
   *        |------+------+------+------+------+------+------+------+------+------+------+------|
   *  RotEn | Del  |   Q  |   W  |   F  |   P  |   T  |   J  |   L  |   U  |   Y  |   :  | \  | |
   * ,------+------+------+------+------+------+------+------+------+------+------+------+------|
   * | QRTY | Bksp | FN/A |   R  |   S  |   T  |   G  |   M  |   N  |   E  |   I  |   O  |  "   |
   * |------+------+------+------+------+------+-------------+------+------+------+------+------|
   * | COMK | Shift|Ctrl/Z|   X  |   C  |   D  |   V  |   K  |   H  |   ,  |   .  |   /  |SH/ENT|
   * |------+------+------+------+------+------+-------------+------+------+------+------+------|
   ...
   */
  	[COMK] = LAYOUT(
              KC_ESC,  KC_F1,   KC_F2,    KC_F3,   KC_F4,   KC_F5,    KC_F6,    KC_F7,    KC_F8,    KC_F9,    KC_F10,   KC_F11,
              KC_EQL,  KC_1,    KC_2,     KC_3,    KC_4,    KC_5,     KC_6,     KC_7,     KC_8,     KC_9,     KC_0,     KC_MINUS,
    KC_MUTE,  KC_DEL,  KC_Q,    KC_W,     KC_F,    KC_P,    KC_B,     KC_J,     KC_L,     KC_U,     KC_Y,     KC_SCLN,  KC_BSLS,
    DF(QRTY), KC_BSPC, _FN_A,   KC_R,     KC_S,    KC_T,    KC_G,     KC_M,     KC_N,     KC_E,     KC_I,     _MD_O,    _WN_QOT,
    DF(COMK), KC_LSFT, _CTL_Z,  KC_X,     KC_C,    KC_D,    KC_V,     KC_K,     KC_H,     KC_COMM,  KC_DOT,   _CTL_SL,  _RSH_EN,
